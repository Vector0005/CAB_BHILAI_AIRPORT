...
router.post('/', [
  ...
  body('pickupLocation').trim().isLength({ min: 3 }).withMessage('Pickup location required'),
  body('dropoffLocation').trim().isLength({ min: 3 }).withMessage('Dropoff location required'),

...
(function(){
  ...
  ready(function(){
    ...
    if(form){ form.addEventListener('submit', function(e){ var loc=(document.getElementById('location')?.value||'').trim(); if(loc.length<5){ e.preventDefault(); setNotice('Enter pickup location (at least 5 characters)', false); } }); }
  });
})();